...
The individual viability for each donor is seen in @fig-donor-viabilities. This fig is inserted as an image.
...
{{< embed notebooks/LCMS/LCMS.qmd#fig-act-3A4-IL6 >}}

{{< embed notebooks/LCMS/LCMS.qmd#fig-act-3A4-IL1B >}}
